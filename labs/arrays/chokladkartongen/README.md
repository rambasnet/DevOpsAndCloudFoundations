...
Write a Bash script to solve the Kattis problemid chokladkartongen: [https://open.kattis.com/problems/chokladkartongen](https://open.kattis.com/problems/chokladkartongen). Note that the last part of the URL, e.g. `chokladkartongen` is the problem id. Read the problem statement carefully to design a correct solution.
