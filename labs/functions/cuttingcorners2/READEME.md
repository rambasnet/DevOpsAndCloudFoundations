...
Write a Bash program to solve the Kattis problemid cuttingcorners2: [https://open.kattis.com/problems/cuttingcorners2](https://open.kattis.com/problems/cuttingcorners2). Note that the last part of the URL, e.g. `cuttingcorners2` is the problem id. Read the problem statement carefully to design a correct solution.
