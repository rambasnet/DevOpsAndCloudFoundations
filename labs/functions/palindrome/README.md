# DevOps Lab - Functions and Unittest

Possible Points: 100

Write a Bash program to solve the Kattis problemid palindrome: [https://open.kattis.com/problems/palindrome](https://open.kattis.com/problems/palindrome). Note that the last part of the URL, e.g. `palindrome` is the problem id. Read the problem statement carefully to design a correct solution.
...
2. Type the contents provided src, tests and Makefile files and fix all fixmes. Write #fixed# after each #fixme.
