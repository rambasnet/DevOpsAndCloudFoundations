# CS1 Lab - Basic Math and Unittest

Possible Points: 100

Write a Bash script to solve the Kattis problemid addtwonumbers: [https://open.kattis.com/problems/addtwonumbers](https://open.kattis.com/problems/addtwonumbers). Note that the last part of the URL, e.g. `addtwonumbers` is the problem id. Read the problem statement carefully to design a correct solution.
