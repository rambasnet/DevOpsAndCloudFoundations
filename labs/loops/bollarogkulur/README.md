# DevOps Lab - Loops and Unittest

Possible Points: 100

Write a Bash program to solve the Kattis problemid bollarogkulur: [https://open.kattis.com/problems/bollarogkulur](https://open.kattis.com/problems/bollarogkulur). Note that the last part of the URL, e.g. `bollarogkulur` is the problem id. Read the problem statement carefully to design a correct solution.
...
2. Type the contents provided in src, tests, and Makefile files and fix all fixmes. Write #fixed# after each #fixme.
