...
Write a Bash program to solve the Kattis problemid sumofpowers: [https://open.kattis.com/problems/sumofpowers](https://open.kattis.com/problems/sumofpowers). Note that the last part of the URL, e.g. `sumofpowers` is the problem id. Read the problem statement carefully to design a correct solution.
