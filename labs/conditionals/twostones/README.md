...
Write a Bash script to solve the Kattis problemid twostones: [https://open.kattis.com/problems/twostones](https://open.kattis.com/problems/twostones). Note that the last part of the URL, e.g. `twostones` is the problem id. Read the problem statement carefully to design a correct solution.
